...
function loadKnowledgeFlowOut(country: string, start: number, end: number) {
  getKnowledgeFlowOut({
    country: country,
    start: start,
    end: end
...
function init() {
  ...
  loadKnowledgeFlowOut(form.country, parseInt(form.yearRange.start), parseInt(form.yearRange.end));
}
